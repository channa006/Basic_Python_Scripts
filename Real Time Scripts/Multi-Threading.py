# parallel_query.py
# In Python threading can be used to run several function calls in concurrently
# Threading module we use Thread class prepend with module name.  threading.Thread()
# Method - start() initiates the thread
# Method - join() makes sure the program for all threads to terminate
